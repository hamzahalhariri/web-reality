...
export default class VRInstance {
   ...
   *   - cursorAutoHide: hide gaze cursor when not on an interactable view,
   *     only considered when cursorEnabled=true.  default=false
   *   - cursorEnabled: show a gaze cursor; default=false
  ...
  constructor(bundle, root, parent, options = {}) {
    ...
    let guiOptions = {
      cursorAutoHide: options.hasOwnProperty('cursorAutoHide')
        ? options.cursorAutoHide : false,
      cursorEnabled: options.hasOwnProperty('cursorEnabled')
        ? options.cursorEnabled : false,
    };
