...
export function load(
  ...
  if (typeof material === 'string') {
    ...
    return Promise.all([
      fetch(obj).then(o => o.text()).then(text => readOBJFile(text)),
      fetch(material).then(m => m.text()).then(text => readMTLFile(text)),
    ...
    return (
      fetch(obj)
      .then(o => o.text())
      .then(text => readOBJFile(text))
      .then((objState: OBJParserState) => {
        return createMesh(objState, {}, material);
      })
    );
  } else {
