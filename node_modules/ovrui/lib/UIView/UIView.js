...
var _FourByFourRect = require('../FourByFourRect/FourByFourRect');

var _MergedBufferGeometry = require('../FourByFourRect/MergedBufferGeometry');

var _CSSBorderGeometry = require('../FourByFourRect/CSSBorderGeometry');
...
function UIView(guiSys, params) {
  ...
  this.backgroundMaterial = new _ThreeShim2.default.MeshBasicMaterial({ color: DEFAULT_BACKGROUND_COLOR, side: _ThreeShim2.default.DoubleSide });
  this.backgroundMaterial.transparent = true;
  this.backgroundMaterial.visible = false;
  this.backgroundMaterial.depthWrite = false;
  this.borderMaterial = new _ThreeShim2.default.MeshBasicMaterial({ color: DEFAULT_BORDER_COLOR, side: _ThreeShim2.default.DoubleSide });
  this.borderMaterial.transparent = true;
  this.borderMaterial.visible = false;
  this.borderMaterial.depthWrite = false;
  this.imageMaterial = new _ThreeShim2.default.MeshBasicMaterial({ color: DEFAULT_IMAGE_COLOR, side: _ThreeShim2.default.DoubleSide });
...
UIView.prototype = Object.assign(Object.create(_ThreeShim2.default.Object3D.prototype), {
  ...
  updateGeometry: function () {
    ...
    return function () {
      ...
      if (this.frameDirty) {
        ...
        this.geometry = new _MergedBufferGeometry.MergedBufferGeometry([new _CSSBorderGeometry.CSSBorderGeometry([this.frame[2], this.frame[3]], this.borderWidth, this.borderRadius, 0.01, -0.0005, BORDER_MAT_INDEX, BACKGROUND_MAT_INDEX), new _FourByFourRect.FourByFourRectGeometry(scaleParams.dims, scaleParams.border, scaleParams.cropUV, IMAGE_MAT_INDEX)]);
  ...
  setImageTexture: function setImageTexture(texture) {
    ...
    if (!texture) {
      ...
      this.imageMaterial.visible = false;
    } else if (texture instanceof _ThreeShim2.default.Texture) {
