...
var Player = function () {
  ...
  function Player() {
    ...
    // If the container is the body tag, attach a listener to resize as the
    // window resizes
    ...
    if (!this._camera) {
      this._camera = new _ThreeShim2.default.PerspectiveCamera(60, width / height, 1, 2000);
    }
    this._initialAngles = {
  ...
  _createClass(Player, [{
     ...
     * oculuswebvr: protocol links, it will try to open that browser.
